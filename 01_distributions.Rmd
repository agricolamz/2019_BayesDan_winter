...
Какое значение соответствует 40% квантили?
```{r}
...
Распределение Пуассона --- распределение число событий, произошедших за фиксированное время, при условии, что данные события происходят с некоторой фиксированной средней интенсивностью ($\lambda$) и независимы друг от друга.
...
В результате мы можем пострить график, который будет правдоподобие моделей с разными средними и фиксированным стандартным отклонением.
