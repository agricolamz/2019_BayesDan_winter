...
Посчитайте долю, которую составляет согласные от всего фонологического набора каждого языка и доверительный интервал для него (`ci.method = "Clopper-Pearson"`). Полученные интервалы округлите до 3 знаков после запятой, а в ответ укажите название языка на букву N с интервалом равный 0.514.
